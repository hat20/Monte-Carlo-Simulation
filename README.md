...
Studied Monte Carlo Simulation for the first time today in my Project Management class and felt that I had to code this simulation.
This here is just RAW code and I would update it and add more features to it. 
